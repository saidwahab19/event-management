...
class Contacts extends ResourceController
{
    ...
    public function create()
    {
        ...
        if(!$save) {
            ...
            return redirect()->to(site_url('contacts'))->with('success', 'Data Berhasil di Simpan');
        }
    }
    ...
    public function update($id = null)
    {
        ...
        if(!$save) {
            ...
            return redirect()->to(site_url('contacts'))->with('success', 'Data Berhasil di Update');
        }
    }
    ...
    public function delete($id = null)
    {
        ...
        return redirect()->to(site_url('contacts'))->with('success', 'Data Berhasil di Hapus');
    }
}
